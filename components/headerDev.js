...
const Navbar8 = (props) => {
    ...
    <>
      <header className="navbar8-container1">
        <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
          ...
          />
          <div data-thq="thq-navbar-nav" className="navbarDev-menu">
  ...
  style={{right: 0 }}>
                <span>
                  {props.action1 ?? (
                    <Fragment>
                      <span className="navbar8-text15">Log Out</span>
                    </Fragment>
                  )}
                </span>
              </button>
                              ...
                              {props.page1Description ?? (
                                <Fragment>
                                  <span className="navbar8-text22">
                                    Navigate to the Home page for web security
                                    information.
                                  </span>
                                </Fragment>
                              )}
                        ...
                        <div className="navbar8-menu-item2">
                          ...
                          <div className="navbar8-content2">
                            <span className="navbar8-page21 thq-body-large">
                              {props.page2 ?? (
                                <Fragment>
                                  <span className="navbar8-text20">About</span>
                                </Fragment>
                              )}
                            </span>
                            <span className="thq-body-small">
                              {props.page2Description ?? (
                                <Fragment>
                                  <span className="navbar8-text23">
                                    Learn more about our website and web
                                    security measures.
                                  </span>
                                </Fragment>
                              )}
                              ...
                              {props.page3Description ?? (
                                <Fragment>
                                  <span className="navbar8-text26">
                                    Access resources and tools to enhance your
                                    web security.
                                  </span>
                                </Fragment>
                              )}
              ...
              <div className="navbar8-buttons2">
                ...
                <button className="thq-button-outline">
                  <span>
                    {props.action2 ?? (
                      <Fragment>
                        <span className="navbar8-text27">Get in Touch</span>
                      </Fragment>
                    )}
                  </span>
                </button>
                    ...
                    <div className="navbar8-content6">
                      ...
                      <span className="thq-body-small">
                        {props.page2Description ?? (
                          <Fragment>
                            <span className="navbar8-text23">
                              Learn more about our website and web security
                              measures.
                            </span>
                          </Fragment>
                        )}
                  ...
                  <div className="navbar8-menu-item7">
                    ...
                    <div className="navbar8-content7">
                      <span className="navbar8-page32 thq-body-large">
                        {props.page3 ?? (
                          <Fragment>
                            <span className="navbar8-text25">Resources</span>
                          </Fragment>
                        )}
                      </span>
                      <span className="thq-body-small">
                        {props.page3Description ?? (
                          <Fragment>
                            <span className="navbar8-text26">
                              Access resources and tools to enhance your web
                              security.
                            </span>
                          </Fragment>
                        )}
...
Navbar8.defaultProps = {
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NjU0MzQwMXw&ixlib=rb-4.1.0&q=80&w=1080',
  action1: undefined,
  ...
  link1: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1489389944381-3471b5b30f04?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NjU0MzQwMnw&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NjU0MzQwNHw&ixlib=rb-4.1.0&q=80&w=1080',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NjU0MzQwNXw&ixlib=rb-4.1.0&q=80&w=1080',
