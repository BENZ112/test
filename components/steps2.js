                  ...
                  {props.step1Description ?? (
                    <Fragment>
                      <span className="steps2-text25">
                        Ensure all software on your devices and systems are up
                  ...
                  {props.step2Description ?? (
                    <Fragment>
                      <span className="steps2-text28">
                        Create complex passwords with a combination of letters,
                  ...
                  {props.step3Description ?? (
                    <Fragment>
                      <span className="steps2-text26">
                        ...
                        form of verification to access your accounts.
                      </span>
                    </Fragment>
                  )}
                </span>
                  ...
                  {props.step4Description ?? (
                    <Fragment>
                      <span className="steps2-text31">
                        Frequently backup important data to prevent loss in case
                        of a cyber attack or system failure.
                      </span>
                    </Fragment>
                  )}
                </span>
